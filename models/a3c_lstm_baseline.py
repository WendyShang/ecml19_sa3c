...
class A3C_LSTM_BASELINE(Model):
    def __init__(self, args):
        super(A3C_LSTM_BASELINE, self).__init__(args)
...
class A3C_LSTM_BASELINE_CRELU(Model):
    def __init__(self, args):
        super(A3C_LSTM_BASELINE_CRELU, self).__init__(args)
